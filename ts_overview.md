...
If you're using the Classic plan, see [Reporting a problem to the {{site.data.keyword.messagehub}} team - Classic plan](/docs/EventStreams?topic=eventstreams-report_problem#report_problem) for a list of the information required by the team.
{:shortdesc}
