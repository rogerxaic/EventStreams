...
<p>For more information, see [Partition leadership](/docs/services/EventStreams?topic=eventstreams-partition_leadership).</dd>
<dt>Producer</dt>
...
- [Producing messages](/docs/services/EventStreams?topic=eventstreams-producing_messages)
- [Consuming messages](/docs/services/EventStreams?topic=eventstreams-consuming_messages) 
- [Partition leadership](/docs/services/EventStreams?topic=eventstreams-partition_leadership) 
