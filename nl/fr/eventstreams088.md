...
* Les types de pont suivants sont fournis : 
  ...
  - Le [pont {{site.data.keyword.objectstorageshort}}](/docs/services/EventStreams/eventstreams089.html){:new_window}, qui transfère les données de {{site.data.keyword.messagehub}} à une instance du service [Object Storage ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](/docs/services/ObjectStorage/index.html){:new_window}.
