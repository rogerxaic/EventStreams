...
Vous trouverez sans doute utile de coupler ces informations à la [consommation de messages](/docs/services/MessageHub/messagehub114.html) dans {{site.data.keyword.messagehub}}.
