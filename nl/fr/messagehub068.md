...
Le protocole TLS chiffre les noms de sujet et les groupes de consommateurs en vue de leur transmission entre {{site.data.keyword.messagehub}} et les clients. Cependant, {{site.data.keyword.messagehub}} ne chiffre pas ces valeurs au repos.
