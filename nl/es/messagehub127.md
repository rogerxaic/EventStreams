...
<li>Pase estas credenciales a la aplicación. Es posible que tenga que volver a transferir la aplicación para que los cambios entren en vigor.</li>
</ol>
...
8. Pase estas credenciales a la aplicación.
...
<li>Pase estas credenciales a la aplicación. </li>
</ol>
...
Los servicios suministrados mediante el plan Empresa se agrupan en el panel de control bajo la cabecera **Servicios**. El plan Empresa está [habilitado para IAM ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://console.bluemix.net/docs/iam/quickstart.html#getstarted){:new_window}. No es necesario que entienda IAM para empezar a trabajar, pero se recomienda tener algunos conocimientos si desea proteger el servicio {{site.data.keyword.messagehub}}. Para obtener más información, consulte [Protección de los recursos de {{site.data.keyword.messagehub}}](/docs/services/MessageHub/messagehub124.html)
...
4. Pulse **Conexiones**.
5. Pulse **Crear conexión**.
6. Seleccione el mosaico de servicio de {{site.data.keyword.messagehub}} con el que desea enlazar y pulse **Conectar**. Esto crea automáticamente un alias de servicio de Cloud Foundry para el servicio {{site.data.keyword.messagehub}} y luego enlaza la aplicación con este alias. Es posible que tenga que volver a transferir la aplicación para que los cambios entren en vigor.
...
<li>Pase estas credenciales a la aplicación.<br/> Es posible que tenga que volver a transferir la aplicación para que los cambios entren en vigor.</li>
</ol>
...
7. Pase estas credenciales a la aplicación. Asegúrese de que la aplicación analiza los detalles.
...
<li>Pase estas credenciales a la aplicación. Asegúrese de que la aplicación analiza los detalles.</li>
</ol>
...
* Si utiliza el plan Estándar, consulte [Elección entre las tres API](/docs/services/MessageHub/messagehub087.html) para obtener información sobre qué cliente elegir y cómo conectarse.
* Si utiliza el plan Empresa, consulte [Utilización de la API Kafka](/docs/services/MessageHub/messagehub050.html).
