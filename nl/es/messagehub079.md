...
<code>password</code> y <code>mqlight_lookup_url</code> de la variable de entorno [VCAP_SERVICES](/docs/services/MessageHub/messagehub127.html). Utilice la siguiente guía para el idioma elegido:
