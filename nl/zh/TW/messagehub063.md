...
* <code>kafka_brokers_sasl</code> 認證，以及來自 [VCAP_SERVICES 環境變數](/docs/services/MessageHub/messagehub127.html#vcap)的 <code>user</code> 及 <code>password</code>。
* 服務金鑰。如需相關資訊，請參閱[連接叢集](/docs/services/MessageHub/messagehub127.html#enterprise_connect)。
