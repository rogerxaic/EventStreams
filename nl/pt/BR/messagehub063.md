...
a seguir: 
* as credenciais <code>kafka_brokers_sasl</code>, além de <code>user</code> e <code>password</code> da [variável de ambiente VCAP_SERVICES](/docs/services/MessageHub/messagehub127.html#vcap).
* a chave de serviço. Para obter mais informações, consulte
[Conectando-se ao seu cluster](/docs/services/MessageHub/messagehub127.html#enterprise_connect).
