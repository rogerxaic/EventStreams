...
# Protezione delle tue risorse {{site.data.keyword.messagehub}} (piano Enterprise)
{: #security }
...
* Cluster (cluster): puoi controllare quali applicazioni e utenti possono connettersi al servizio [e accedere all'IU] 
...
* Il tipo di servizio a cui si applica la politica. Ad esempio, Message Hub. Puoi definire l'ambito di una politica per includere tutti i tipi di servizio. 
...
Per informazioni su come eseguire il bind di un'applicazione Cloud Foundry od ottenere una credenziale della chiave di sicurezza per un'applicazione esterna, vedi [Connessione a Message Hub](/docs/services/MessageHub/messagehub127.html#connect_messagehub).
