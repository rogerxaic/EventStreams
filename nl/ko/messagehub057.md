...
## Kafka 부트스트랩 서버가 실패하는 경우 Java Kafka 호출은 장애 복구를 수행하지 않습니다. 
{: #calls_failover}
...
Kafka 클라이언트 또는 Kafka Streams를 사용하여 토픽을 작성할 때 허용되는 설정의 제한사항에 대한 정보는 [토픽 관리용 API](/docs/services/MessageHub/messagehub104.html)를 참조하십시오.
