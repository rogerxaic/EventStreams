...
{{site.data.keyword.messagehub}}에 연결하기 위해 Kafka API는 다음 신임 정보 세트 중 하나를 사용합니다. 
* [VCAP_SERVICES 환경 변수](/docs/services/MessageHub/messagehub127.html#vcap)의
<code>user</code> 및 <code>password</code>와 <code>kafka_brokers_sasl</code> 신임 정보
* 서비스 키. 자세한 정보는 [클러스터에 연결](/docs/services/MessageHub/messagehub127.html#enterprise_connect)을 참조하십시오.
