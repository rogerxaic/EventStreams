...
# {{site.data.keyword.messagehub}}에서 Kafka API를 사용하는 데 필요한 사항
{: #kafka_reqs}

{{site.data.keyword.messagehub}}에서 Kafka API를 사용하려면 다음 요구사항이 필요합니다.

* 다음 Apache Kafka 클라이언트 중 하나:
	* [Apache Kafka 1.1 클라이언트 ![외부 링크 아이콘](../../icons/launch-glyph.svg "외부 링크 아이콘")](https://www.apache.org/dyn/closer.cgi?path=/kafka/1.1.0/kafka_2.11-1.1.0.tgz){:new_window}
