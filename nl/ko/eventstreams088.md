...
* 다음 유형의 브릿지를 제공합니다. 
  ...
  - [{{site.data.keyword.objectstorageshort}} 브릿지](/docs/services/EventStreams?topic=eventstreams-object_storage_bridge)는 2018년 8월 1일부터 더 이상 사용되지 않습니다. 자세한 정보는 [사용 중단 공지사항: {{site.data.keyword.objectstorageshort}} OpenStack Swift(PaaS) ![외부 링크 아이콘](../../icons/launch-glyph.svg "외부 링크 아이콘")](https://www.ibm.com/blogs/cloud-archive/2018/05/end-marketing-object-storage-openstack-swift-paas/){:new_window}를 참조하십시오.
