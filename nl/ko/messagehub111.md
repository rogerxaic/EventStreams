...
토픽 API는 설정 없이 {{site.data.keyword.messagehub}}에 대한 작업을 수행할 수 있습니다. <code>sasl.jaas.config</code> 또는 JAAS 파일을 사용하여 SASL 신임 정보를 지정하고 <code>replication.factor</code>를 3으로 설정하십시오.
